  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        {/* Call to Action */}
        <div className="mt-16">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 rounded-2xl p-8 text-center relative overflow-hidden">            
            <div className="relative z-10">
              ...
              <p className="text-lg text-white/90 mb-6 max-w-xl mx-auto">
                Our expert team is ready to help you with personalized guidance
              </p>
              
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <button className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-blue-600 font-semibold rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105 transform">
                  <MessageCircle className="w-5 h-5" />
                  Start Live Chat
                </button>
                
                <button className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/20 text-white font-semibold rounded-xl hover:bg-white/30 transition-all duration-300 border border-white/30">
