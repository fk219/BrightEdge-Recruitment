...
const WhyChooseUs = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-gradient-to-br from-slate-50 via-white to-blue-50 py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-200/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-200/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse delay-1000"></div>
      
      {/* Floating elements */}
      <div className="absolute top-20 left-20 text-blue-300 animate-bounce">
        <Sparkles className="w-6 h-6" />
      </div>
      <div className="absolute bottom-32 right-16 text-purple-300 animate-bounce delay-1000">
