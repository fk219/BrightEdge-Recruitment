  ...
  const contactMethods = [
    {
      ...
      details: [{ label: "Phone", value: "+971 54 377 2366", primary: true }],
    ...
    },
    {
      ...
      title: "Live Chat",
      description:
        "Get instant answers to your questions with our real-time chat support system.",
      color: "orange",
      ...
      details: [],
      availability: ["Average response: 2 minutes", "Available 24/7"],
