...
import { Home, Search, ArrowLeft, Mail, Phone, MapPin, Sparkles, RefreshCw } from 'lucide-react';
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div ref={numbersRef} className="mb-8">
            <h1 className="text-[12rem] sm:text-[16rem] lg:text-[20rem] font-black leading-none">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 drop-shadow-2xl">
                404
              </span>
            </h1>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 max-w-md mx-auto">
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-sm font-medium text-blue-900">Auto-redirecting to home</p>
                  <p className="text-xs text-blue-600">in {countdown} seconds</p>
                </div>
              </div>
            </div>
